...
def get_ans_dtt_pairs():
    with open(f'/user_data/Cloze/dataset/sciq/mask_sentence_with_dtt/sciq_train_ans_dtt_pair.json', "r", encoding="utf-8") as f:
        data = json.load(f)
        return data
...
with open('/user_data/Cloze/dataset/sciq_passsage_debug/sciq_train_mask_passage_with_dtt_for_t5(3dtt).json', "w", encoding="utf-8") as f:
