...
with open('/user_data/Cloze/dataset/sciq/mask_sentence_with_dtt/bart/sciq_train_mask_passage_with_dtt_for_bart(3dtt)_dtt_retrieve.json', "w", encoding="utf-8") as f:
