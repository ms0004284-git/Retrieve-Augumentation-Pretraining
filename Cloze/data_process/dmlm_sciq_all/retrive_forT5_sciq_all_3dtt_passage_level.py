...
def get_passages_with_word(text, word, data_len):
    ...
    for passage in passages:
        ...
        if len(result) + data_len >= 3: # 控制每個 ans dtt pair 最多只能生9筆
            break
    return result
...
with open('/user_data/Cloze/dataset/sciq/mask_sentence_with_dtt/t5_new/parameter_analysis/sciq_all_mask_passage_with_dtt_for_t5_k=3.json', "w", encoding="utf-8") as f:
