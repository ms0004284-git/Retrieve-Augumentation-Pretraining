...
def get_ans_dtt_pairs():
    with open(f'/user_data/CTG/data/MCQ/total_new_cleaned_train_splited.json', "r", encoding="utf-8") as f:
        data = json.load(f)
        return data
...
with open('/user_data/Cloze/dataset/mcq/mask_sentence_with_dtt/bart/mcq_train_mask_passage_with_dtt_for_bart(3dtt)_dtt_retrieve.json', "w", encoding="utf-8") as f:
